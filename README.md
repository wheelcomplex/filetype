# filetype [![Build Status](https://travis-ci.org/h2non/filetype.png)](https://travis-ci.org/h2non/filetype) [![GoDoc](https://godoc.org/github.com/wheelcomplex/filetype?status.svg)](https://godoc.org/github.com/wheelcomplex/filetype) [![Go Report Card](http://goreportcard.com/badge/h2non/filetype)](http://goreportcard.com/report/h2non/filetype) [![Go Version](https://img.shields.io/badge/go-v1.0+-green.svg?style=flat)](https://github.com/wheelcomplex/gentleman)
...
For SVG file type checking, see [go-is-svg](https://github.com/wheelcomplex/go-is-svg) package.
...
```bash
go get github.com/wheelcomplex/filetype
```

## API

See [Godoc](https://godoc.org/github.com/wheelcomplex/filetype) reference.

### Subpackages

- [`github.com/wheelcomplex/filetype/types`](https://godoc.org/github.com/wheelcomplex/filetype/types)
- [`github.com/wheelcomplex/filetype/matchers`](https://godoc.org/github.com/wheelcomplex/filetype/matchers)
...
Measured using [real files](https://github.com/wheelcomplex/filetype/tree/master/fixtures).
